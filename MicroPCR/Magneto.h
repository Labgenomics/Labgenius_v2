...
#define M_PUMPING_POS_UP_OFFSET			(int)0 //KSY			// -값을 주면 PUMPING 축이 상승(원하는 위치에 도달하지 못했을 때)
	// +값을 주면 PUMPING 축이 하강(원하는 위치보다 초과하였을 때)
#define M_PUMPING_DISK_RADIUS			(float)2.8//s1-2.8//2.83//2.3	//kSY	// puming syringe의 반지름으로 mm 단위로 입력
